...
//
//        Exception e = assertThrows(InvalidDateException.class, () -> service.createTask(task));
//
...
//
//        Exception e = assertThrows(ForbiddenException.class, ()-> service.updateTask(dataWithPropToUpdate, request, entity.getId()));
//
...
//        when(request.getAttribute("idUser")).thenReturn("Unauthorized");
//
//        Exception e = assertThrows(ForbiddenException.class, ()-> service.deleteTask(any(), request));
//
//        String expectedMessage = "Usuário e/ou senha incorretos";
//        String actualMessage = e.getMessage();
//
...
//        when(request.getAttribute("idUser")).thenReturn("Unauthorized");
//
//        Exception e = assertThrows(ForbiddenException.class, ()-> service.getTaskSpecificUser(request));
//
//        String expectedMessage = "Usuário e/ou senha incorretos";
//        String actualMessage = e.getMessage();
//
...
//        when(request.getAttribute("idUser")).thenReturn("Unauthorized");
//
//        Exception e = assertThrows(ForbiddenException.class, () -> service.findTaskById(entity.getId(), request));
//
//        String expectedMessage = "Usuário e/ou senha incorretos";
//        String actualMessage = e.getMessage();
//
